...
const styles = StyleSheet.create({
  ...
  prov: { flexGrow: 1, flexBasis: "46%", borderRadius: 16, padding: 14, gap: 3, shadowColor: "#0A2540", shadowOpacity: 0.035, shadowRadius: 10, shadowOffset: { width: 0, height: 3 }, elevation: 1 },
  provLabel: { fontSize: 14, fontWeight: "700" },
  provSub: { fontSize: 11, fontWeight: "500" },
  skeleton: { height: 50, borderRadius: 14, opacity: 0.35 },
  form: { gap: 14 },
  gap: { gap: 8 },
  ...
  segmentItem: { flex: 1, height: 42, borderRadius: 12, alignItems: "center", justifyContent: "center" },
  segmentText: { fontSize: 12.5, fontWeight: "700" },
  limitCard: { borderRadius: 18, borderWidth: 1, padding: 20, alignItems: "center", gap: 5, shadowColor: "#0A2540", shadowOpacity: 0.04, shadowRadius: 12, shadowOffset: { width: 0, height: 4 }, elevation: 1 },
